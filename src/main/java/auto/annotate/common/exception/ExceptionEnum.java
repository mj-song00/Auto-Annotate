...
public enum ExceptionEnum {
    ...
    PASSWORD_SAME_AS_OLD(HttpStatus.BAD_REQUEST, "PASSWORD_SAME_AS_OLD", "이전과 다른 비밀번호를 입력해주세요."),
    PASSWORD_MISMATCH(HttpStatus.BAD_REQUEST, "PASSWORD_MISMATCH", "기존 비밀번호를 확인해주세요."),
